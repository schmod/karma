...
exports.watch = function(patterns, excludes, fileList, usePolling, basePath) {
  ...
  var gaze = new Gaze(watchedPatterns, options, function(err, watcher){
    if(err){
...
exports.watch.$inject = ['config.files', 'config.exclude', 'fileList', 'config.usePolling', 'config.basePath'];
